      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
            {active.length === 0 ? 'All clear' : `${active.length} remaining`}
          </p>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-3">
          <div
            style={{
              ...
              height: '44px',
              borderRadius: '12px',
              background: 'color-mix(in srgb, var(--active) 10%, var(--surface-2))',
              border: '1px solid color-mix(in srgb, var(--active) 25%, var(--border))',
              display: 'flex',
              alignItems: 'center',
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '11px', color: 'var(--text-faint)', marginTop: '3px' }}>
              No tasks due today. Visit the Tasks page to add new ones.
            </p>
          </div>
        </div>
      ) : (
        <div className="flex-1 overflow-auto">
          {active.map((task, i) => {
            ...
            return (
              ...
              >
                <div
                  className="group flex items-start gap-3 cursor-pointer rounded-lg -mx-2"
                  style={{
                    padding: '8px 8px',
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '50%',
                      border: `1.5px solid ${done ? 'var(--active)' : color}`,
                      background: done ? 'var(--active)' : 'transparent',
                  ...
                  <div className="flex-1 min-w-0">
                    <p style={{
                      fontSize: '14px',
                      lineHeight: '1.4',
                      color: overdue ? 'var(--urgent)' : 'var(--text)',
                      marginBottom: '3px',
                    }}>
                      {task.title}
                    </p>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {overdue && (
                        <span style={{ fontSize: '11px', color: 'var(--urgent)', fontWeight: 500 }}>
                          overdue
                        </span>
                      )}
                    </div>
